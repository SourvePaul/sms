...
<head>
    ...
    <title>Sign In | Perfect Learn</title>
</head>
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body" action="{{route('login')}}" method="post" enctype="multipart/form-data">
                                    @csrf
{{--                                    <div class="d-grid">--}}
{{--                                        <a class="btn btn-white radius-30" href="{{asset('adminAsset/')}}/javascript:;"><span class="d-flex justify-content-center align-items-center">--}}
...
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-6 text-end">	<a href="{{asset('adminAsset/')}}/authentication-forgot-password.html">Forgot Password ?</a>--}}
{{--                                        </div>--}}
                                        <div class="col-12">
                                            <div class="d-grid">
